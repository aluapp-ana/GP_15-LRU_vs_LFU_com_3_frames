...
class Frame:
    ...
    def __init__(self, id_frame):
        ...
        # LRU - instante do último acesso a página neste frame
        # menor valor = usado há mais tempo = candidato a remoção
        self.ultimo_acesso = -1

        # LFU - Total de acessos a página desde que foi carregada
        # menor valor = menos frequente = candidato a remoção
        self.contador = 0
